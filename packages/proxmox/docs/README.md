...
| proxmox.cluster.resource.cgroup_mode | Cgroup mode (node only). | long |  |  |
...
| proxmox.cluster.resource.vmid | VM or container ID. | long |  |  |
| proxmox.ha.group | HA group name. | keyword |  |  |
| proxmox.ha.max_relocate | Maximum relocate attempts. | long |  |  |
| proxmox.ha.max_restart | Maximum restart attempts. | long |  |  |
...
| proxmox.node.cpuinfo.sockets | Number of CPU sockets. | long |  |  |
